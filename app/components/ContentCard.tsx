...
export default function ContentCard({ href, title }: { href: string, title: string }) {
  return (
    <Link href={href} >
      <div className=" h-28 w-36 p-3 rounded-2xl backdrop-blur-xl backdrop-saturate-100 bg-black bg-opacity-5 shadow-lg border-2 border-opacity-20 border-gray-300">
